...
bot = telebot.TeleBot('7273976322:AAHVl0uL9iBbA3xyGGJC8nFra5O4AWnffRAA')
    ...
    if user_id in admin_id:
        ...
        if len(command) > 1:
            ...
            if user_to_add not in allowed_user_ids:
                ...
                response = f"User {user_to_add} Ok add dine 👍."
            else:
                response = "User already exists 🤦‍♂️."
        else:
            response = "Id bhejo kise add karna he \nlike this👇\n/add 000000000."
    else:
        response = "🫵Sorry Bhai Aap Ye Wala Button \n ✋Use Nhi Kar Sakte he \n Command Sirf he 3 Bande Hi Use Kar Sakte Hn\n @JJ_MODZ_OWNERR\n@TeamXhackerr"
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "🫵Sorry Bhai Aap Ye Wala Button \n ✋Use Nhi Kar Sakte \nPehle JJ_MODZ_OWNERRR SE BAAT KRO\n@JJ_MODZ_OWNERRR."
